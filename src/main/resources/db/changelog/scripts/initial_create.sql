...
CREATE TABLE palette_rgba_colors (
...
ALTER TABLE palette ADD CONSTRAINT fknsv7ph76u3xkvi622b8yqyvdl FOREIGN KEY (character_id) REFERENCES character(id);
ALTER TABLE palette_rgba_colors ADD CONSTRAINT fk8qlwtjrxrkryk19nldkmmp48f FOREIGN KEY (palette_id) REFERENCES palette(id);
